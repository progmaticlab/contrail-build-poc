...
cd %{buildroot}/usr/src/vrouter && tar zcf %{buildroot}/_centos/tmp/contrail-vrouter-%{_verstr}.tar.gz .
sed "s/__VERSION__/"%{_verstr}"/g" %{buildroot}/centos/dkms.conf.in > %{buildroot}/usr/src/vrouter/dkms.conf
rm  %{buildroot}/centos/dkms.conf.in
